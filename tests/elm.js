...
var _user$project$FormattedValue$bompengeAndel = A2(
	_evancz$focus$Focus$create,
	function (_) {
		return _.bompengeAndel;
	},
	F2(
		function (f, specificState) {
			return _elm_lang$core$Native_Utils.update(
				specificState,
				{
					bompengeAndel: f(specificState.bompengeAndel)
				});
		}));
var _user$project$FormattedValue$installationCost = A2(
	_evancz$focus$Focus$create,
	function (_) {
		return _.installationCost;
	},
	F2(
		function (f, specificState) {
			return _elm_lang$core$Native_Utils.update(
				specificState,
				{
					installationCost: f(specificState.installationCost)
				});
		}));
var _user$project$FormattedValue$sykkelturerPerYear = A2(
	_evancz$focus$Focus$create,
	function (_) {
		return _.sykkelturerPerYear;
	},
	F2(
		function (f, specificState) {
			return _elm_lang$core$Native_Utils.update(
				specificState,
				{
					sykkelturerPerYear: f(specificState.sykkelturerPerYear)
				});
		}));
var _user$project$FormattedValue$yearlyMaintenance = A2(
	_evancz$focus$Focus$create,
	function (_) {
		return _.yearlyMaintenance;
	},
	F2(
		function (f, specificState) {
			return _elm_lang$core$Native_Utils.update(
				specificState,
				{
					yearlyMaintenance: f(specificState.yearlyMaintenance)
				});
		}));
var _user$project$FormattedValue$value = A2(
	_evancz$focus$Focus$create,
	function (_) {
		return _.value;
	},
	F2(
		function (f, formattedValue) {
			return _elm_lang$core$Native_Utils.update(
				formattedValue,
				{
					value: f(formattedValue.value)
				});
		}));
var _user$project$FormattedValue$installationCostValue = A2(_evancz$focus$Focus_ops['=>'], _user$project$FormattedValue$installationCost, _user$project$FormattedValue$value);
var _user$project$FormattedValue$state = A2(
	_evancz$focus$Focus$create,
	function (_) {
		return _.state;
	},
	F2(
		function (f, formattedValue) {
			return _elm_lang$core$Native_Utils.update(
				formattedValue,
				{
					state: f(formattedValue.state)
				});
		}));
var _user$project$FormattedValue$FormattedValue = F2(
	function (a, b) {
		return {value: a, state: b};
	});
var _user$project$FormattedValue$Display = {ctor: 'Display'};
var _user$project$FormattedValue$formattedValueDefault = {value: _elm_lang$core$Maybe$Nothing, state: _user$project$FormattedValue$Display};
var _user$project$FormattedValue$formattedValue = function (value) {
	return {value: value, state: _user$project$FormattedValue$Display};
};
var _user$project$FormattedValue$Edit = {ctor: 'Edit'};

var _user$project$SpecificStates$BasicState = F2(
	function (a, b) {
		return {sykkelturerPerYear: a, preferredToGraph: b};
	});

var _user$project$TiltakStates$TiltakStates = F3(
	function (a, b, c) {
		return {kollektivPrioriteringLyskryss: a, opphoeyetHoldeplass: b, ledLys: c};
	});

var _user$project$Models$Model = F4(
	function (a, b, c, d) {
		return {page: a, accordionState: b, tiltakStates: c, chartIds: d};
	});
var _user$project$Models$Field = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {name: a, title: b, placeholder: c, stepSize: d, value: e, isEditable: f, beDisplayMode: g, beEditMode: h, focus: i};
	});
var _user$project$Models$Vedlikehold = {ctor: 'Vedlikehold'};
var _user$project$Models$Belysning = {ctor: 'Belysning'};
var _user$project$Models$NotFound = {ctor: 'NotFound'};
var _user$project$Models$GroupPage = function (a) {
	return {ctor: 'GroupPage', _0: a};
};
var _user$project$Models$Home = {ctor: 'Home'};

var _user$project$Field$transformToFields = function (fieldDefinitions) {
	var toRealField = function (simpleField) {
		return {
			...
			isEditable: function (tiltakStates) {
				var _p0 = A2(
					_evancz$focus$Focus$get,
					A2(_evancz$focus$Focus_ops['=>'], simpleField.focus, _user$project$FormattedValue$state),
					tiltakStates);
				if (_p0.ctor === 'Edit') {
					return true;
				} else {
			...
			beDisplayMode: function (tiltakStates) {
				return A3(
					_evancz$focus$Focus$set,
					A2(_evancz$focus$Focus_ops['=>'], simpleField.focus, _user$project$FormattedValue$state),
					_user$project$FormattedValue$Display,
					tiltakStates);
			},
			beEditMode: function (tiltakStates) {
				return A3(
					_evancz$focus$Focus$set,
					A2(_evancz$focus$Focus_ops['=>'], simpleField.focus, _user$project$FormattedValue$state),
					_user$project$FormattedValue$Edit,
					tiltakStates);
			},
			value: _evancz$focus$Focus$get(
				A2(_evancz$focus$Focus_ops['=>'], simpleField.focus, _user$project$FormattedValue$value))
		};
	};
	return A2(_elm_lang$core$List$map, toRealField, fieldDefinitions);
};
var _user$project$Field$SimpleField = F5(
	function (a, b, c, d, e) {
		return {name: a, title: b, placeholder: c, stepSize: d, focus: e};
	});

var _user$project$Tiltak$getAttr = F2(
	function (_p0, accessor) {
		var _p1 = _p0;
		return accessor(_p1._0);
	});
var _user$project$Tiltak$sendTo = F2(
	function (_p2, recordAccessor) {
		var _p3 = _p2;
		return A2(recordAccessor, _p3._0, _p3);
	});
var _user$project$Tiltak$bindTiltak = F3(
	function (tiltak, tiltakStates, accessor) {
		return A3(_user$project$Tiltak$sendTo, tiltak, accessor, tiltakStates);
	});
var _user$project$Tiltak$analyse = F2(
	function (tiltak, tiltakStates) {
		var f = A2(_user$project$Tiltak$bindTiltak, tiltak, tiltakStates);
		return {
			brukerNytte: f(
				function (_) {
					return _.brukerNytte;
				}),
			analysePeriode: 40,
			kostUtenSkyggepris: f(
				function (_) {
					return _.kostUtenSkyggepris;
				}),
			isProfitable: A2(
				_elm_lang$core$Maybe$map,
				function (value) {
					return _elm_lang$core$Native_Utils.cmp(value, 0) > 0;
				},
				f(
					function (_) {
						return _.nettoNytte;
			...
			nettoNyttePerBudsjettKrone: A3(
				_elm_lang$core$Maybe$map2,
				F2(
					function (nettoNytte, kostUtenSkyggepris) {
						return nettoNytte / _elm_lang$core$Basics$negate(kostUtenSkyggepris);
					}),
				f(
					function (_) {
						return _.nettoNytte;
...
var _user$project$Tiltak$AnalyseData = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {brukerNytte: a, kostUtenSkyggepris: b, analysePeriode: c, isProfitable: d, trafikantNytte: e, nytte: f, skyggepris: g, nettoNytte: h, nettoNyttePerBudsjettKrone: i};
	});
var _user$project$Tiltak$TiltakRecord = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
												...
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return function (q) {
																	return {title: a, fields: b, brukerNytte: c, trafikantNytte: d, nytte: e, skyggepris: f, skyggeprisHelper: g, kostUtenSkyggepris: h, nettoNytte: i, yearlyBrukerNytte: j, yearlyTrafikantNytte: k, driftOgVedlihKost: l, investeringsKostInklRestverdi: m, graphId: n, domId: o, preferredField: p, preferredToGraphFocus: q};
																};
															};
														};
													};
...
var _user$project$Tiltak$Tiltak = function (a) {
	return {ctor: 'Tiltak', _0: a};
};

var _user$project$Msgs$UpdateFieldToGraph = F2(
	function (a, b) {
		return {ctor: 'UpdateFieldToGraph', _0: a, _1: b};
	});
var _user$project$Msgs$FieldFocus = function (a) {
	return {ctor: 'FieldFocus', _0: a};
};
var _user$project$Msgs$FieldBlur = function (a) {
	return {ctor: 'FieldBlur', _0: a};
};
var _user$project$Msgs$ChartsChanged = function (a) {
	return {ctor: 'ChartsChanged', _0: a};
};
var _user$project$Msgs$UpdateField = F3(
	function (a, b, c) {
		return {ctor: 'UpdateField', _0: a, _1: b, _2: c};
	});
var _user$project$Msgs$AccordionMsg = function (a) {
...
var _user$project$NumberFormat$norwegianLocale = {decimals: 3, thousandSeparator: ' ', decimalSeparator: ',', negativePrefix: '-', negativeSuffix: ''};
var _user$project$NumberFormat$pretty = function (value) {
	return A2(
		_cuducos$elm_format_number$FormatNumber$format,
		_elm_lang$core$Native_Utils.update(
			_user$project$NumberFormat$norwegianLocale,
			{decimals: 0}),
		value);
};
var _user$project$NumberFormat$maybePretty = function (maybeValue) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'Ugyldig kalkulasjon',
		A2(_elm_lang$core$Maybe$map, _user$project$NumberFormat$pretty, maybeValue));
};
var _user$project$NumberFormat$prettyTwoDecimals = function (value) {
	return A2(
		_cuducos$elm_format_number$FormatNumber$format,
		_elm_lang$core$Native_Utils.update(
			_user$project$NumberFormat$norwegianLocale,
...
var _user$project$NumberFormat$maybePrettyTwoDecimals = function (maybeValue) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'Ugyldig kalkulasjon',
		A2(_elm_lang$core$Maybe$map, _user$project$NumberFormat$prettyTwoDecimals, maybeValue));
};

var _user$project$AnalyseView$conclusionRow = function (data) {
	var conclusionContent = function (isProfitable) {
		return {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('isProfitableMark'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('conclusion'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Konklusjon'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Ufullstendige data'),
							_1: {ctor: '[]'}
						},
						A2(_elm_lang$core$Maybe$map, conclusionContent, data.isProfitable))),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$AnalyseView$view = function (data) {
	var gridRow = function (_p2) {
		var _p3 = _p2;
		return A2(
			_rundis$elm_bootstrap$Bootstrap_Grid$row,
			{
				...
				_0: _rundis$elm_bootstrap$Bootstrap_Grid_Row$attrs(
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('analyseColumn'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('nkaTooltip'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('nkaTooltipContent'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
	...
	var titleAndValueList = {
		ctor: '::',
		_0: {
			ctor: '_Tuple3',
			_0: A2(
				_elm_lang$core$Basics_ops['++'],
				'Brukerenes nytte over ',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(data.analysePeriode),
					' år')),
			_1: _user$project$NumberFormat$maybePretty(data.brukerNytte),
			_2: _elm_lang$html$Html$text('Verdien i dag av brukerenes tids- og bekvemmelighetsgevinster, over hele analyseperioden')
		},
		_1: {
			ctor: '::',
			_0: {
				...
				_0: A2(
					_elm_lang$core$Basics_ops['++'],
					'Øvrige trafikanters nytte over ',
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(data.analysePeriode),
						' år')),
				_1: _user$project$NumberFormat$maybePretty(data.trafikantNytte),
				_2: _elm_lang$html$Html$text('Verdien i dag av effektene på øvrige trafikanter, over hele analyseperioden')
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_0: A2(
						_elm_lang$core$Basics_ops['++'],
						'Sum nytteelementer over ',
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(data.analysePeriode),
							' år')),
					_1: _user$project$NumberFormat$maybePretty(data.nytte),
					...
					_0: {
						...
						_0: A2(
							...
							A2(
								...
								_elm_lang$core$Basics$toString(data.analysePeriode),
								' år')),
						_1: _user$project$NumberFormat$maybePretty(data.kostUtenSkyggepris),
						_2: _elm_lang$html$Html$text('Verdien i dag av alle kostnader (drift/vedlikehold, investering og ev. gjeninvestering) som vil påløpe i analyseperioden')
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple3',
							_0: 'Skyggepris offentlige midler',
							_1: _user$project$NumberFormat$maybePretty(data.skyggepris),
							_2: _elm_lang$html$Html$text('Samfunnskostnaden (effektivitetstapet) som påløper når tiltaket er skattefinansiert')
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple3',
								_0: 'Tiltakets nettonåverdi',
								_1: _user$project$NumberFormat$maybePretty(data.nettoNytte),
								_2: _elm_lang$html$Html$text('Nytteelementer minus kostnadselementer. Tiltaket er lønnsomt hvis tallet er positivt.')
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple3',
									_0: 'Nettonytte per budsjettkrone (nyttekostnadsbrøk)',
									_1: _user$project$NumberFormat$maybePrettyTwoDecimals(data.nettoNyttePerBudsjettKrone),
									_2: _elm_lang$html$Html$text('Uttrykk for hvor mye samfunnet får igjen for hver krone tiltaket koster. Tiltaket er lønnsomt hvis tallet er positivt')
								},
								_1: {ctor: '[]'}
							}
						}
	...
	var dataRows = A2(_elm_lang$core$List$map, gridRow, titleAndValueList);
	var gridRows = A2(
		_elm_lang$core$Basics_ops['++'],
		dataRows,
		{
			ctor: '::',
			_0: _user$project$AnalyseView$conclusionRow(data),
			_1: {ctor: '[]'}
		});
	return {
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Samfunnsøkonomisk analyse'),
				_1: {ctor: '[]'}
			}),
		_1: gridRows
	};
...
var _user$project$Assets$src = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$html$Html_Attributes$src(_p1._0);
};
var _user$project$Assets$Image = function (a) {
	return {ctor: 'Image', _0: a};
};
var _user$project$Assets$byvaapen = _user$project$Assets$Image('./images/oslo_byvaapen_liten.png');
var _user$project$Assets$toiLogo = _user$project$Assets$Image('./images/toi_logo_navn.png');
var _user$project$Assets$backArrow = _user$project$Assets$Image('./images/689246_arrows_512x512.png');
var _user$project$Assets$trikkRikshospitalet = _user$project$Assets$Image('./images/trikk_rikshospitalet.jpg');
var _user$project$Assets$bussholdeplass = _user$project$Assets$Image('./images/samuel-foster-199587.jpg');
var _user$project$Assets$caretRight = _user$project$Assets$Image('./images/caret_right.gif');
var _user$project$Assets$holdeplasser = _user$project$Assets$Image('./images/holdeplass_noun_1230795_cc.gif');
var _user$project$Assets$informasjon = _user$project$Assets$Image('./images/info_noun_45.gif');
var _user$project$Assets$trygghet = _user$project$Assets$Image('./images/sikkerhet.gif');
var _user$project$Assets$kjoeremateriell = _user$project$Assets$Image('./images/buss_noun_1308908_cc.gif');
var _user$project$Assets$strekningOgFramkommelighet = _user$project$Assets$Image('./images/gatekryss_noun_1277963_cc.gif');
var _user$project$Assets$tilgjengelighet = _user$project$Assets$Image('./images/noun_1050600_cc.gif');

var _user$project$GeneralForutsetninger$skyggepris = 0.2;
var _user$project$GeneralForutsetninger$analysePeriode = 40;
var _user$project$GeneralForutsetninger$afaktorCalculation = function (drenteValue) {
	return (1 / drenteValue) * (1 - (1 / Math.pow(1 + drenteValue, _user$project$GeneralForutsetninger$analysePeriode)));
};
var _user$project$GeneralForutsetninger$vekstrate = 0.8 / 100;
var _user$project$GeneralForutsetninger$drente = 4 / 100;
var _user$project$GeneralForutsetninger$drenteVekst = (_user$project$GeneralForutsetninger$drente - _user$project$GeneralForutsetninger$vekstrate) / (1 + _user$project$GeneralForutsetninger$vekstrate);
var _user$project$GeneralForutsetninger$afaktorVekst = _user$project$GeneralForutsetninger$afaktorCalculation(_user$project$GeneralForutsetninger$drenteVekst);
var _user$project$GeneralForutsetninger$investeringsFaktor = function (levetid) {
	var beregningsTekniskMellomregning = _elm_lang$core$Basics$toFloat(
		((_user$project$GeneralForutsetninger$analysePeriode / _elm_lang$core$Basics$truncate(levetid)) | 0) + 1);
	var ledd1 = (1 - Math.pow(
		1 + _user$project$GeneralForutsetninger$drente,
		_elm_lang$core$Basics$negate(levetid) * beregningsTekniskMellomregning)) / (1 - Math.pow(
		1 + _user$project$GeneralForutsetninger$drente,
		_elm_lang$core$Basics$negate(levetid)));
	var ledd2 = (_user$project$GeneralForutsetninger$analysePeriode - (levetid * beregningsTekniskMellomregning)) / (levetid * Math.pow(1 + _user$project$GeneralForutsetninger$drente, _user$project$GeneralForutsetninger$analysePeriode));
	return ledd1 + ledd2;
};
var _user$project$GeneralForutsetninger$afaktor = _user$project$GeneralForutsetninger$afaktorCalculation(_user$project$GeneralForutsetninger$drente);
var _user$project$GeneralForutsetninger$verdisettinger = {reisetidKollektivTransport: 1.29, reisetidBil: 2.46, sitteplassPaaHpl: 3.99, leskurPaaBussholdeplassenUtenSitteplass: 7.87, leskurPaaBussholdeplassenMedSitteplass: 10.08, renholdPaaHpl: 8.61, fjerningAvIsSnoePaaHpl: 12.67, opphoyetHoldeplass: 1.04, rutekartPaaHpl: 2.79, lokalkartPaaHpl: 4.09, skiltingIBuss: 5.05, destinasjonsSkiltPaaBuss: 0.76, avviksinformasjonHoeyttaler: 0.86, hplOpprop: 3.52, bussrenhold: 3.64, belysning: 6.93, vektere: 4.0, alarmsystemPaaHpl: 4.08, lavgulvUtenTilpassetHoldeplass: 2.08, lavgulvMedTilpassetHoldeplass: 2.17, pakkeSkiltOgOppropBuss: 5.24, operatoerKostnad: 7.81};

var _user$project$BasicTiltak$yearlyMaintenancePlaceholder = 'Årlige (økninger i) kostnader til drift og vedlikehold som knytter seg til dette tiltaket';
var _user$project$BasicTiltak$driftOgVedlihKost = function (specificState) {
	return A2(
		_elm_lang$core$Maybe$map,
		...
		A2(
			...
			F2(
				function (x, y) {
					return x * y;
				})(_user$project$GeneralForutsetninger$afaktor),
			specificState.yearlyMaintenance.value));
};
var _user$project$BasicTiltak$investeringsKostInklRestverdi = F2(
	function (specificState, levetid) {
		return A2(
			_elm_lang$core$Maybe$map,
			_elm_lang$core$Basics$negate,
			A2(
				...
				F2(
					...
					_user$project$GeneralForutsetninger$investeringsFaktor(levetid)),
				A2(
					_evancz$focus$Focus$get,
					A2(_evancz$focus$Focus_ops['=>'], _user$project$FormattedValue$installationCost, _user$project$FormattedValue$value),
					specificState)));
	});
var _user$project$BasicTiltak$preferredField = F3(
	function (specificStateFocus, tiltak, tiltakStates) {
		var fieldName = A2(
			_evancz$focus$Focus$get,
			A2(
				_user$project$Tiltak$getAttr,
				tiltak,
				function (_) {
					return _.preferredToGraphFocus;
				}),
			tiltakStates);
		var filterByName = function (field) {
			return _elm_lang$core$Native_Utils.eq(field.name, fieldName);
		};
		return _elm_lang$core$List$head(
			A2(
				...
				filterByName,
				A2(
					_user$project$Tiltak$sendTo,
					tiltak,
					function (_) {
						return _.fields;
					})));
	});
var _user$project$BasicTiltak$preferredToGraph = A2(
	_evancz$focus$Focus$create,
	function (_) {
		return _.preferredToGraph;
	},
	F2(
		function (f, state) {
			return _elm_lang$core$Native_Utils.update(
				state,
				{
					preferredToGraph: f(state.preferredToGraph)
				});
		}));
var _user$project$BasicTiltak$skyggeprisHelper = F3(
	function ($this, state, bompengeAndel) {
		var calculation = function (kostUtenSkyggepris) {
			return ((1 - bompengeAndel) * kostUtenSkyggepris) * _user$project$GeneralForutsetninger$skyggepris;
		};
		return A2(
			_elm_lang$core$Maybe$map,
			calculation,
...
var _user$project$BasicTiltak$kostUtenSkyggepris = F2(
	function ($this, state) {
		var f = A2(_user$project$Tiltak$bindTiltak, $this, state);
		return A3(
			_elm_lang$core$Maybe$map2,
			F2(
				function (x, y) {
			...
			f(
				function (_) {
					return _.investeringsKostInklRestverdi;
				}),
			f(
				function (_) {
					return _.driftOgVedlihKost;
				}));
	});
var _user$project$BasicTiltak$analysePeriodeNytteFor = F3(
	function (accessor, $this, state) {
		return A2(
			_elm_lang$core$Maybe$map,
			F2(
				function (x, y) {
					return x * y;
				})(_user$project$GeneralForutsetninger$afaktorVekst),
			A3(_user$project$Tiltak$sendTo, $this, accessor, state));
	});
var _user$project$BasicTiltak$trafikantNytte = _user$project$BasicTiltak$analysePeriodeNytteFor(
	function (_) {
		return _.yearlyTrafikantNytte;
	});
var _user$project$BasicTiltak$brukerNytte = _user$project$BasicTiltak$analysePeriodeNytteFor(
	function (_) {
		return _.yearlyBrukerNytte;
	});
var _user$project$BasicTiltak$nettoNytte = F2(
	function ($this, state) {
		var f = A2(_user$project$Tiltak$bindTiltak, $this, state);
		return A4(
...
var _user$project$BasicTiltak$nytte = F2(
	function ($this, state) {
		var f = function (accessor) {
			return A3(_user$project$Tiltak$sendTo, $this, accessor, state);
		};
		return A3(
			_elm_lang$core$Maybe$map2,
			F2(
...
var _user$project$BasicTiltak$toDomId = function (string) {
	return A2(
		_elm_lang$core$String$join,
		'-',
...
var _user$project$BasicTiltak$basicTiltakRecord = function (specificStateFocus) {
	return {
		title: function (_p1) {
			return 'Basic tiltak';
		},
		...
		brukerNytte: _user$project$BasicTiltak$brukerNytte,
		trafikantNytte: _user$project$BasicTiltak$trafikantNytte,
		kostUtenSkyggepris: _user$project$BasicTiltak$kostUtenSkyggepris,
		nettoNytte: _user$project$BasicTiltak$nettoNytte,
		nytte: _user$project$BasicTiltak$nytte,
		skyggepris: F2(
			function (_p4, _p3) {
				return _elm_lang$core$Maybe$Nothing;
			}),
		skyggeprisHelper: _user$project$BasicTiltak$skyggeprisHelper,
		yearlyBrukerNytte: F2(
			function (_p6, _p5) {
				return _elm_lang$core$Maybe$Nothing;
			}),
		yearlyTrafikantNytte: F2(
			function (_p8, _p7) {
				return _elm_lang$core$Maybe$Just(0);
			}),
		driftOgVedlihKost: F2(
			function (_p10, _p9) {
				return _elm_lang$core$Maybe$Nothing;
			}),
		investeringsKostInklRestverdi: F2(
			function (_p12, _p11) {
				return _elm_lang$core$Maybe$Nothing;
			}),
		graphId: function ($this) {
			return A2(
				F2(
					function (x, y) {
						return A2(_elm_lang$core$Basics_ops['++'], x, y);
		...
		domId: function ($this) {
			return _user$project$BasicTiltak$toDomId(
				A2(
					_user$project$Tiltak$sendTo,
					$this,
					function (_) {
		...
		preferredField: _user$project$BasicTiltak$preferredField(specificStateFocus),
		preferredToGraphFocus: A2(_evancz$focus$Focus_ops['=>'], specificStateFocus, _user$project$BasicTiltak$preferredToGraph)
	};
};

var _user$project$Charting$stepCount = F2(
	function (stepSize, number) {
		return _elm_lang$core$Basics$toFloat(
			_elm_lang$core$Basics$round(number / stepSize));
	});
var _user$project$Charting$roundToStepSize = F2(
	function (stepSize, number) {
		return stepSize * A2(_user$project$Charting$stepCount, stepSize, number);
	});
var _user$project$Charting$samplesFromBreakEvenPoint = F2(
	function (stepSize, nullPunkt) {
		var stepClosestToNullPunkt = A2(_user$project$Charting$roundToStepSize, stepSize, nullPunkt);
		var minimum = 0;
		var samplesOnEachSide = 4;
		var start = A2(_elm_lang$core$Basics$max, stepClosestToNullPunkt - (stepSize * samplesOnEachSide), 0);
		var steps = A2(
			_elm_lang$core$List$map,
			function (index) {
			...
			A2(
				_elm_lang$core$List$map,
				_elm_lang$core$Basics$toFloat,
				A2(_elm_lang$core$List$range, 0, samplesOnEachSide * 2)));
		var _p0 = _elm_lang$core$Native_Utils.cmp(nullPunkt, minimum) > 0;
		if (_p0 === true) {
			return _elm_lang$core$List$sort(
				_elm_lang$core$Set$toList(
					_elm_lang$core$Set$fromList(
						{ctor: '::', _0: nullPunkt, _1: steps})));
		} else {
			return steps;
		}
	});
var _user$project$Charting$breakEvenPoint = function (func) {
	var b = func(0);
	var x1 = 1;
	var x0 = 0;
	var a = (func(x1) - func(x0)) / (x1 - x0);
	var _p1 = a;
	if (_p1 === 0) {
		return _elm_lang$core$Maybe$Nothing;
	} else {
		return _elm_lang$core$Maybe$Just((0 - b) / a);
	}
};
var _user$project$Charting$samples = F2(
	function (stepSize, generateDataFunc) {
		var _p2 = _user$project$Charting$breakEvenPoint(generateDataFunc);
		if (_p2.ctor === 'Just') {
			return A2(_user$project$Charting$samplesFromBreakEvenPoint, stepSize, _p2._0);
		} else {
			return {ctor: '[]'};
		}
	});

var _user$project$Group$groupTitle = function (tag) {
	var _p0 = tag;
	if (_p0.ctor === 'Vedlikehold') {
		return 'Fra GsB (brøyt og strø) til GsA (sop og salt / barvegsstandard)';
	} else {
		return 'Fra ingen/eldre belysning til LED-belysning';
	}
};
var _user$project$Group$groupPathSansHash = function (tag) {
	return _elm_lang$core$String$toLower(
		_elm_lang$core$Basics$toString(tag));
};
var _user$project$Group$groupPath = function (tag) {
	return A2(
		F2(
			function (x, y) {
				return A2(_elm_lang$core$Basics_ops['++'], x, y);
		...
		'#',
		_user$project$Group$groupPathSansHash(tag));
};

var _user$project$Ports$generateC3 = _elm_lang$core$Native_Platform.outgoingPort(
	'generateC3',
	function (v) {
		return {
			domId: v.domId,
			...
			variableTitle: v.variableTitle
		};
	});
var _user$project$Ports$destroyC3 = _elm_lang$core$Native_Platform.outgoingPort(
	'destroyC3',
	function (v) {
		return v;
	});
var _user$project$Ports$updateC3 = _elm_lang$core$Native_Platform.outgoingPort(
	'updateC3',
	function (v) {
		return {
			domId: v.domId,
...
var _user$project$Ports$charts = _elm_lang$core$Native_Platform.incomingPort(
	'charts',
	_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string));
var _user$project$Ports$setTitle = _elm_lang$core$Native_Platform.outgoingPort(
	'setTitle',
	function (v) {
		return v;
	});
var _user$project$Ports$GraphData = F3(
	function (a, b, c) {
		return {domId: a, data: b, variableTitle: c};
	});

var _user$project$Tiltak_KollektivPrioriteringLyskryss$antallPasserendeAvgangerPerYear = A2(
	_evancz$focus$Focus$create,
	function (_) {
		return _.antallPasserendeAvgangerPerYear;
	},
	F2(
		function (f, state) {
			return _elm_lang$core$Native_Utils.update(
...
var _user$project$Tiltak_KollektivPrioriteringLyskryss$forsinkelsePerBilSeconds = A2(
	_evancz$focus$Focus$create,
	function (_) {
		return _.forsinkelsePerBilSeconds;
	},
	F2(
		function (f, state) {
			return _elm_lang$core$Native_Utils.update(
...
var _user$project$Tiltak_KollektivPrioriteringLyskryss$antallBilerForsinketPerAvgang = A2(
	_evancz$focus$Focus$create,
	function (_) {
		return _.antallBilerForsinketPerAvgang;
	},
	F2(
		function (f, state) {
			return _elm_lang$core$Native_Utils.update(
...
var _user$project$Tiltak_KollektivPrioriteringLyskryss$specificStateFocus = A2(
	_evancz$focus$Focus$create,
	function (_) {
		return _.kollektivPrioriteringLyskryss;
	},
	F2(
		function (f, tiltakStates) {
			return _elm_lang$core$Native_Utils.update(
				tiltakStates,
				{
					kollektivPrioriteringLyskryss: f(tiltakStates.kollektivPrioriteringLyskryss)
				});
		}));
var _user$project$Tiltak_KollektivPrioriteringLyskryss$fieldDefinitions = {
	ctor: '::',
	_0: {
		name: 'installationCost',
		title: 'Installasjonskostnad',
		placeholder: 'Kostnaden ved å installere tiltaket en gang, kroner',
		focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_KollektivPrioriteringLyskryss$specificStateFocus, _user$project$FormattedValue$installationCost),
		stepSize: 50000
	},
	_1: {
		ctor: '::',
		_0: {
			...
			placeholder: _user$project$BasicTiltak$yearlyMaintenancePlaceholder,
			focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_KollektivPrioriteringLyskryss$specificStateFocus, _user$project$FormattedValue$yearlyMaintenance),
			stepSize: 5000
		},
		_1: {
			ctor: '::',
			_0: {
				...
				focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_KollektivPrioriteringLyskryss$specificStateFocus, _user$project$FormattedValue$sykkelturerPerYear),
				stepSize: 50
			},
			_1: {
				ctor: '::',
				_0: {
					...
					focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_KollektivPrioriteringLyskryss$specificStateFocus, _user$project$Tiltak_KollektivPrioriteringLyskryss$antallBilerForsinketPerAvgang),
					stepSize: 1
				},
				_1: {
					ctor: '::',
					_0: {
						...
						focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_KollektivPrioriteringLyskryss$specificStateFocus, _user$project$Tiltak_KollektivPrioriteringLyskryss$forsinkelsePerBilSeconds),
						stepSize: 1
					},
					_1: {
						ctor: '::',
						_0: {
							...
							focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_KollektivPrioriteringLyskryss$specificStateFocus, _user$project$Tiltak_KollektivPrioriteringLyskryss$antallPasserendeAvgangerPerYear),
							stepSize: 1000
						},
						_1: {ctor: '[]'}
					}
...
var _user$project$Tiltak_KollektivPrioriteringLyskryss$fields = _user$project$Field$transformToFields(_user$project$Tiltak_KollektivPrioriteringLyskryss$fieldDefinitions);
var _user$project$Tiltak_KollektivPrioriteringLyskryss$initialState = {installationCost: _user$project$FormattedValue$formattedValueDefault, yearlyMaintenance: _user$project$FormattedValue$formattedValueDefault, sykkelturerPerYear: _user$project$FormattedValue$formattedValueDefault, antallBilerForsinketPerAvgang: _user$project$FormattedValue$formattedValueDefault, forsinkelsePerBilSeconds: _user$project$FormattedValue$formattedValueDefault, antallPasserendeAvgangerPerYear: _user$project$FormattedValue$formattedValueDefault, preferredToGraph: ''};
var _user$project$Tiltak_KollektivPrioriteringLyskryss$skyggepris = F2(
	function ($this, _p0) {
		var _p1 = _p0;
		return A4(
			_user$project$Tiltak$sendTo,
			$this,
			function (_) {
				return _.skyggeprisHelper;
			},
			_p1,
			0);
	});
var _user$project$Tiltak_KollektivPrioriteringLyskryss$driftOgVedlihKost = F2(
	function ($this, _p2) {
		var _p3 = _p2;
		return _user$project$BasicTiltak$driftOgVedlihKost(_p3.kollektivPrioriteringLyskryss);
	});
var _user$project$Tiltak_KollektivPrioriteringLyskryss$yearlyTrafikantNytte = F2(
	function ($this, _p4) {
		var _p5 = _p4;
		var _p6 = _p5.kollektivPrioriteringLyskryss;
		return A4(
			_elm_lang$core$Maybe$map3,
			F3(
				function (antallBilerForsinketPerAvgang, antallPasserendeAvgangerPerYear, forsinkelsePerBilSeconds) {
					return ((antallBilerForsinketPerAvgang * antallPasserendeAvgangerPerYear) * (_elm_lang$core$Basics$negate(forsinkelsePerBilSeconds) / 60)) * _user$project$GeneralForutsetninger$verdisettinger.reisetidBil;
				}),
			_p6.antallBilerForsinketPerAvgang.value,
			_p6.antallPasserendeAvgangerPerYear.value,
			_p6.forsinkelsePerBilSeconds.value);
	});
var _user$project$Tiltak_KollektivPrioriteringLyskryss$tidsbesparelsePerAvgangSeconds = 20;
var _user$project$Tiltak_KollektivPrioriteringLyskryss$yearlyBrukerNytte = F2(
	function ($this, tiltakStates) {
		return A2(
			_elm_lang$core$Maybe$map,
			function (sykkelturerPerYear) {
				return ((_user$project$Tiltak_KollektivPrioriteringLyskryss$tidsbesparelsePerAvgangSeconds / 60) * _user$project$GeneralForutsetninger$verdisettinger.reisetidKollektivTransport) * sykkelturerPerYear;
			},
			A2(
				_evancz$focus$Focus$get,
				A2(
					_evancz$focus$Focus_ops['=>'],
					A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_KollektivPrioriteringLyskryss$specificStateFocus, _user$project$FormattedValue$sykkelturerPerYear),
					_user$project$FormattedValue$value),
				tiltakStates));
	});
var _user$project$Tiltak_KollektivPrioriteringLyskryss$yearlyOperatoerNytte = F2(
	function ($this, _p7) {
		var _p8 = _p7;
		var calculation = function (passerendeAvganger) {
			return (passerendeAvganger * (_user$project$Tiltak_KollektivPrioriteringLyskryss$tidsbesparelsePerAvgangSeconds / 60)) * _user$project$GeneralForutsetninger$verdisettinger.operatoerKostnad;
		};
		return A2(_elm_lang$core$Maybe$map, calculation, _p8.kollektivPrioriteringLyskryss.antallPasserendeAvgangerPerYear.value);
	});
var _user$project$Tiltak_KollektivPrioriteringLyskryss$levetid = 15;
var _user$project$Tiltak_KollektivPrioriteringLyskryss$investeringsKostInklRestverdi = F2(
	function ($this, _p9) {
		var _p10 = _p9;
		return A2(_user$project$BasicTiltak$investeringsKostInklRestverdi, _p10.kollektivPrioriteringLyskryss, _user$project$Tiltak_KollektivPrioriteringLyskryss$levetid);
	});
var _user$project$Tiltak_KollektivPrioriteringLyskryss$tiltak = function () {
	var basicTiltakRecord = _user$project$BasicTiltak$basicTiltakRecord(_user$project$Tiltak_KollektivPrioriteringLyskryss$specificStateFocus);
	return _user$project$Tiltak$Tiltak(
		_elm_lang$core$Native_Utils.update(
			basicTiltakRecord,
			{
				title: function (_p11) {
					return 'Kollektivprioritering i lyskryss';
				},
				yearlyBrukerNytte: _user$project$Tiltak_KollektivPrioriteringLyskryss$yearlyBrukerNytte,
				yearlyTrafikantNytte: _user$project$Tiltak_KollektivPrioriteringLyskryss$yearlyTrafikantNytte,
				investeringsKostInklRestverdi: _user$project$Tiltak_KollektivPrioriteringLyskryss$investeringsKostInklRestverdi,
				driftOgVedlihKost: _user$project$Tiltak_KollektivPrioriteringLyskryss$driftOgVedlihKost,
				skyggepris: _user$project$Tiltak_KollektivPrioriteringLyskryss$skyggepris,
				fields: function (_p12) {
					return _user$project$Tiltak_KollektivPrioriteringLyskryss$fields;
				}
			}));
}();

var _user$project$Tiltak_LEDLys$initialState = {installationCost: _user$project$FormattedValue$formattedValueDefault, yearlyMaintenance: _user$project$FormattedValue$formattedValueDefault, sykkelturerPerYear: _user$project$FormattedValue$formattedValueDefault, lengdeSykkelveiKm: _user$project$FormattedValue$formattedValueDefault, preferredToGraph: ''};
var _user$project$Tiltak_LEDLys$levetid = 25;
var _user$project$Tiltak_LEDLys$ledTidsbesparelseMinutterPerTur = 0.5;
var _user$project$Tiltak_LEDLys$yearlyBrukerNytte = F2(
	function ($this, _p0) {
		var _p1 = _p0;
		var verdisettinger = _user$project$GeneralForutsetninger$verdisettinger;
		var firstCalc = function (sykkelturerPerYear) {
			return sykkelturerPerYear * verdisettinger.opphoyetHoldeplass;
		};
		var first = A2(_elm_lang$core$Maybe$map, firstCalc, _p1.ledLys.sykkelturerPerYear.value);
		var secondCalc = F2(
			function (beleggForbiPassasjererPerBuss, yearlyTidsbesparelseMinutter) {
				return (beleggForbiPassasjererPerBuss * yearlyTidsbesparelseMinutter) * verdisettinger.reisetidKollektivTransport;
			});
		return A3(
			_elm_lang$core$Maybe$map2,
			F2(
...
var _user$project$Tiltak_LEDLys$specificState = A2(
	_evancz$focus$Focus$create,
	function (_) {
		return _.ledLys;
	},
...
var _user$project$Tiltak_LEDLys$fieldDefinitions = function () {
	var lengdeSykkelveiKm = A2(
		_evancz$focus$Focus$create,
		function (_) {
			return _.lengdeSykkelveiKm;
		},
		F2(
			function (f, specificState) {
				return _elm_lang$core$Native_Utils.update(
	...
	return {
		...
		_0: {
			...
			title: 'Installasjonskostnad',
			placeholder: 'Kostnaden ved å installere tiltaket en gang, kroner',
			focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_LEDLys$specificState, _user$project$FormattedValue$installationCost),
			stepSize: 50000
		},
		_1: {
			ctor: '::',
			_0: {
				...
				title: 'Årlige drifts- og vedlikeholdskostnader',
				placeholder: _user$project$BasicTiltak$yearlyMaintenancePlaceholder,
				focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_LEDLys$specificState, _user$project$FormattedValue$yearlyMaintenance),
				stepSize: 5000
			},
			_1: {
				ctor: '::',
				_0: {
					...
					focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_LEDLys$specificState, lengdeSykkelveiKm),
					stepSize: 5
				},
				_1: {
					ctor: '::',
					_0: {
						...
						focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_LEDLys$specificState, _user$project$FormattedValue$sykkelturerPerYear),
						stepSize: 50
					},
					_1: {ctor: '[]'}
				}
...
var _user$project$Tiltak_LEDLys$fields = _user$project$Field$transformToFields(_user$project$Tiltak_LEDLys$fieldDefinitions);
var _user$project$Tiltak_LEDLys$tiltak = function () {
	var basicTiltakRecord = _user$project$BasicTiltak$basicTiltakRecord(_user$project$Tiltak_LEDLys$specificState);
	return _user$project$Tiltak$Tiltak(
		_elm_lang$core$Native_Utils.update(
			basicTiltakRecord,
			{
				title: function (_p2) {
					return 'LED-lys for syklende';
				},
				fields: function (_p3) {
					return _user$project$Tiltak_LEDLys$fields;
				},
				yearlyBrukerNytte: _user$project$Tiltak_LEDLys$yearlyBrukerNytte,
				investeringsKostInklRestverdi: F2(
					function (_p5, _p4) {
						var _p6 = _p4;
						return A2(_user$project$BasicTiltak$investeringsKostInklRestverdi, _p6.ledLys, _user$project$Tiltak_LEDLys$levetid);
					}),
				driftOgVedlihKost: F2(
					function (_p8, _p7) {
						var _p9 = _p7;
						return _user$project$BasicTiltak$driftOgVedlihKost(_p9.ledLys);
					}),
				skyggepris: F2(
					function ($this, _p10) {
						var _p11 = _p10;
...
var _user$project$Tiltak_OpphoeyetHoldeplass$initialState = {installationCost: _user$project$FormattedValue$formattedValueDefault, yearlyMaintenance: _user$project$FormattedValue$formattedValueDefault, sykkelturerPerYear: _user$project$FormattedValue$formattedValueDefault, beleggForbiPassasjererPerBuss: _user$project$FormattedValue$formattedValueDefault, yearlyTidsbesparelseMinutter: _user$project$FormattedValue$formattedValueDefault, preferredToGraph: ''};
var _user$project$Tiltak_OpphoeyetHoldeplass$levetid = 25;
var _user$project$Tiltak_OpphoeyetHoldeplass$yearlyBrukerNytte = F2(
	function ($this, _p0) {
		var _p1 = _p0;
		var _p2 = _p1.opphoeyetHoldeplass;
		var verdisettinger = _user$project$GeneralForutsetninger$verdisettinger;
		var firstCalc = function (sykkelturerPerYear) {
			return sykkelturerPerYear * verdisettinger.opphoyetHoldeplass;
		};
		var first = A2(_elm_lang$core$Maybe$map, firstCalc, _p2.sykkelturerPerYear.value);
		var secondCalc = F2(
			function (beleggForbiPassasjererPerBuss, yearlyTidsbesparelseMinutter) {
				return (beleggForbiPassasjererPerBuss * yearlyTidsbesparelseMinutter) * verdisettinger.reisetidKollektivTransport;
			});
		var second = A3(_elm_lang$core$Maybe$map2, secondCalc, _p2.beleggForbiPassasjererPerBuss.value, _p2.yearlyTidsbesparelseMinutter.value);
		return A3(
			_elm_lang$core$Maybe$map2,
			F2(
				function (x, y) {
...
var _user$project$Tiltak_OpphoeyetHoldeplass$specificState = A2(
	_evancz$focus$Focus$create,
	function (_) {
		return _.opphoeyetHoldeplass;
	},
	F2(
		function (f, tiltakStates) {
			return _elm_lang$core$Native_Utils.update(
...
var _user$project$Tiltak_OpphoeyetHoldeplass$fieldDefinitions = function () {
	var yearlyTidsbesparelseMinutter = A2(
		_evancz$focus$Focus$create,
		function (_) {
			return _.yearlyTidsbesparelseMinutter;
		},
		F2(
			function (f, specificState) {
				return _elm_lang$core$Native_Utils.update(
	...
	var beleggForbiPassasjererPerBuss = A2(
		_evancz$focus$Focus$create,
		function (_) {
			return _.beleggForbiPassasjererPerBuss;
		},
		F2(
			function (f, specificState) {
				return _elm_lang$core$Native_Utils.update(
	...
	return {
		...
		_0: {
			...
			title: 'Installasjonskostnad',
			placeholder: 'Kostnaden ved å installere tiltaket en gang, kroner',
			focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_OpphoeyetHoldeplass$specificState, _user$project$FormattedValue$installationCost),
			stepSize: 50000
		},
		_1: {
			ctor: '::',
			_0: {
				...
				title: 'Årlige drifts- og vedlikeholdskostnader',
				placeholder: _user$project$BasicTiltak$yearlyMaintenancePlaceholder,
				focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_OpphoeyetHoldeplass$specificState, _user$project$FormattedValue$yearlyMaintenance),
				stepSize: 5000
			},
			_1: {
				ctor: '::',
				_0: {
					...
					focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_OpphoeyetHoldeplass$specificState, _user$project$FormattedValue$sykkelturerPerYear),
					stepSize: 50
				},
				_1: {
					ctor: '::',
					_0: {
						...
						focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_OpphoeyetHoldeplass$specificState, beleggForbiPassasjererPerBuss),
						stepSize: 5
					},
					_1: {
						ctor: '::',
						_0: {
							...
							focus: A2(_evancz$focus$Focus_ops['=>'], _user$project$Tiltak_OpphoeyetHoldeplass$specificState, yearlyTidsbesparelseMinutter),
							stepSize: 1000
						},
						_1: {ctor: '[]'}
					}
...
var _user$project$Tiltak_OpphoeyetHoldeplass$fields = _user$project$Field$transformToFields(_user$project$Tiltak_OpphoeyetHoldeplass$fieldDefinitions);
var _user$project$Tiltak_OpphoeyetHoldeplass$tiltak = function () {
	var basicTiltakRecord = _user$project$BasicTiltak$basicTiltakRecord(_user$project$Tiltak_OpphoeyetHoldeplass$specificState);
	return _user$project$Tiltak$Tiltak(
		_elm_lang$core$Native_Utils.update(
			basicTiltakRecord,
			{
				title: function (_p3) {
					return 'Opphøyet holdeplass';
				},
				fields: function (_p4) {
					return _user$project$Tiltak_OpphoeyetHoldeplass$fields;
				},
				yearlyBrukerNytte: _user$project$Tiltak_OpphoeyetHoldeplass$yearlyBrukerNytte,
				investeringsKostInklRestverdi: F2(
					function (_p6, _p5) {
						var _p7 = _p5;
						return A2(_user$project$BasicTiltak$investeringsKostInklRestverdi, _p7.opphoeyetHoldeplass, _user$project$Tiltak_OpphoeyetHoldeplass$levetid);
					}),
				driftOgVedlihKost: F2(
					function (_p9, _p8) {
						var _p10 = _p8;
						return _user$project$BasicTiltak$driftOgVedlihKost(_p10.opphoeyetHoldeplass);
					}),
				skyggepris: F2(
					function ($this, _p11) {
						var _p12 = _p11;
...
var _user$project$TiltakAndGroupData$initialTiltakStates = {kollektivPrioriteringLyskryss: _user$project$Tiltak_KollektivPrioriteringLyskryss$initialState, opphoeyetHoldeplass: _user$project$Tiltak_OpphoeyetHoldeplass$initialState, ledLys: _user$project$Tiltak_LEDLys$initialState};
var _user$project$TiltakAndGroupData$tiltakForGroup = function (gruppeType) {
	var _p0 = gruppeType;
	if (_p0.ctor === 'Belysning') {
		return {
			ctor: '::',
			_0: _user$project$Tiltak_LEDLys$tiltak,
			_1: {ctor: '[]'}
		};
	} else {
		return {ctor: '[]'};
...
var _user$project$TiltakAndGroupData$alleTyper = {
	ctor: '::',
	_0: _user$project$Models$Belysning,
	_1: {
		ctor: '::',
		_0: _user$project$Models$Vedlikehold,
		_1: {ctor: '[]'}
	}
};

var _user$project$TiltakCharting$graphDataForField = F3(
	function (tiltak, state, field) {
		var stateFrom = function (x) {
			return A3(
				_evancz$focus$Focus$set,
				A2(_evancz$focus$Focus_ops['=>'], field.focus, _user$project$FormattedValue$value),
				_elm_lang$core$Maybe$Just(x),
				state);
		};
		var generateData = function (x) {
			return A2(
				_elm_lang$core$Maybe$map,
				function (y) {
		...
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				generateData,
				A2(_user$project$Charting$samples, field.stepSize, sampleFunc)));
	});
var _user$project$TiltakCharting$maybeFieldToGraph = F2(
	function (tiltak, state) {
		var filterFunc = function (field) {
			var _p2 = field.value(state);
			if (_p2.ctor === 'Just') {
				return false;
			} else {
				return true;
		...
		if (_p3.ctor === '::') {
			...
			return A3(
				...
				tiltak,
				function (_) {
					return _.preferredField;
				},
				state);
		}
	});
var _user$project$TiltakCharting$possibleFieldsToGraph = F2(
	function (tiltak, state) {
		var maybeFieldToGraphName = A2(
			_elm_lang$core$Maybe$map,
			function (_) {
				return _.name;
			},
			A2(_user$project$TiltakCharting$maybeFieldToGraph, tiltak, state));
		var filterFunc = function (field) {
			var _p4 = field.value(state);
			if (_p4.ctor === 'Just') {
				return false;
			} else {
				return true;
		...
		var _p5 = nothingFields;
		if (_p5.ctor === '[]') {
			return function () {
				var _p6 = maybeFieldToGraphName;
				if (_p6.ctor === 'Just') {
					return _elm_lang$core$List$filter(
						function (field) {
							return !_elm_lang$core$Native_Utils.eq(field.name, _p6._0);
						});
				} else {
...
var _user$project$TiltakCharting$graphData = F2(
	function (tiltak, state) {
		var maybeField = A2(_user$project$TiltakCharting$maybeFieldToGraph, tiltak, state);
		var _p7 = maybeField;
		if (_p7.ctor === 'Nothing') {
			return {ctor: '[]'};
		} else {
			return A3(_user$project$TiltakCharting$graphDataForField, tiltak, state, _p7._0);
		}
	});
var _user$project$TiltakCharting$chartRecord = F2(
	function (tiltak, tiltakStates) {
		return {
			domId: A2(
				_user$project$Tiltak$sendTo,
			...
			data: A2(_user$project$TiltakCharting$graphData, tiltak, tiltakStates),
			variableTitle: A2(
				_elm_lang$core$Maybe$withDefault,
				'WAT!!!!',
				A2(
					...
					A2(_user$project$TiltakCharting$maybeFieldToGraph, tiltak, tiltakStates)))
		};
	});
var _user$project$TiltakCharting$GraphOn = {ctor: 'GraphOn'};
var _user$project$TiltakCharting$GraphOff = {ctor: 'GraphOff'};
var _user$project$TiltakCharting$graphState = F2(
	function (tiltak, state) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_user$project$TiltakCharting$GraphOff,
			A2(
				_elm_lang$core$Maybe$map,
				_elm_lang$core$Basics$always(_user$project$TiltakCharting$GraphOn),
				A2(_user$project$TiltakCharting$maybeFieldToGraph, tiltak, state)));
	});

var _user$project$TiltakView$chart = F2(
	function (tiltakStates, tiltak) {
		var graphNodeContent = function () {
			var _p0 = A2(_user$project$TiltakCharting$graphState, tiltak, tiltakStates);
			if (_p0.ctor === 'GraphOn') {
				return {ctor: '[]'};
			} else {
				return {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Legg inn flere tall for å vise graf'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				};
		...
		var fieldButton = function (field) {
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(field.title),
					_1: {ctor: '[]'}
				});
		};
		var alternateFieldsToGraph = function () {
			var _p1 = A2(_user$project$TiltakCharting$possibleFieldsToGraph, tiltak, tiltakStates);
			if (_p1.ctor === '[]') {
				return {ctor: '[]'};
			} else {
				return {
					ctor: '::',
					_0: _elm_lang$html$Html$text('Vis heller: '),
					_1: {
						ctor: '::',
						_0: A2(
							_rundis$elm_bootstrap$Bootstrap_ButtonGroup$buttonGroup,
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, fieldButton, _p1)),
						_1: {ctor: '[]'}
					}
				};
			}
		}();
		var fieldToGraphName = A2(
			_elm_lang$core$Maybe$withDefault,
			'WAT!!!!',
			A2(
				_elm_lang$core$Maybe$map,
				...
				A2(_user$project$TiltakCharting$maybeFieldToGraph, tiltak, tiltakStates)));
		var variableToGraphView = function () {
			var _p2 = A2(_user$project$TiltakCharting$graphState, tiltak, tiltakStates);
			if (_p2.ctor === 'GraphOn') {
				return {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('chartLedetekst'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], 'Grafen viser hvordan tiltakets\nnettonåverdi varierer med ', fieldToGraphName)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id(graphId),
						_1: {ctor: '[]'}
					},
					graphNodeContent),
				_1: {
...
var _user$project$TiltakView$fieldLabelContent = function (field) {
	var _p3 = field.name;
	switch (_p3) {
		case 'yearlyTidsbesparelseMinutter':
			return {
				ctor: '::',
				_0: _elm_lang$html$Html$text(field.title),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(' (se '),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$a,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('https://www.toi.no/getfile.php?mmfileid=16420'),
									_1: {ctor: '[]'}
								}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('rapport'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
		...
		case 'installationCost':
			return {
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(' (se evt. veiledning i '),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$a,
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('rapport 1121'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
...
var _user$project$TiltakView$fieldView = F3(
	function (tiltak, tiltakStates, _p4) {
		var _p5 = _p4;
		var _p9 = _p5.name;
		var _p8 = _p5;
		var isEditable = _p8.isEditable(tiltakStates);
		var fieldValueString = A2(
			_elm_lang$core$Maybe$withDefault,
			'',
			function () {
				var _p6 = isEditable;
				if (_p6 === true) {
					return _elm_lang$core$Maybe$map(_elm_lang$core$Basics$toString);
				} else {
					return _elm_lang$core$Maybe$map(_user$project$NumberFormat$pretty);
				}
			}()(
				_p8.value(tiltakStates)));
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$for(_p9),
						_1: {ctor: '[]'}
					},
					_user$project$TiltakView$fieldLabelContent(_p8)),
				_1: {
					ctor: '::',
					_0: inputElement(
						{
							ctor: '::',
							_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$id(_p9),
							_1: {
								ctor: '::',
								_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$placeholder(_p5.placeholder),
								_1: {
									ctor: '::',
									_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$attrs(
										{
											...
											_0: _elm_lang$html$Html_Events$onBlur(
												_user$project$Msgs$FieldBlur(_p8)),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onFocus(
													_user$project$Msgs$FieldFocus(_p8)),
												_1: {ctor: '[]'}
											}
										}),
									_1: {
										...
										_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$onInput(
											A2(_user$project$Msgs$UpdateField, tiltak, _p8)),
										_1: {
											ctor: '::',
											_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$value(fieldValueString),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$TiltakView$tiltakForm = F2(
	function (tiltak, tiltakStates) {
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				A2(_user$project$TiltakView$fieldView, tiltak, tiltakStates),
				A2(
					_user$project$Tiltak$sendTo,
					tiltak,
					function (_) {
...
var _user$project$TiltakView$tiltakCard = F2(
	function (tiltakStates, tiltak) {
		var title = A2(
			_user$project$Tiltak$sendTo,
			tiltak,
		...
		var analyse = _user$project$AnalyseView$view(
			A2(_user$project$Tiltak$analyse, tiltak, tiltakStates));
		return _rundis$elm_bootstrap$Bootstrap_Accordion$card(
			{
				id: A2(
					_user$project$Tiltak$sendTo,
				...
				options: {ctor: '[]'},
				header: A2(
					_rundis$elm_bootstrap$Bootstrap_Accordion$headerH4,
					{ctor: '[]'},
					A2(
							...
							_0: _rundis$elm_bootstrap$Bootstrap_Card$custom(
								A2(
									...
									A2(
										...
										{
											ctor: '::',
											_0: A2(_user$project$TiltakView$tiltakForm, tiltak, tiltakStates),
											_1: {ctor: '[]'}
										},
										analyse))),
							_1: {ctor: '[]'}
						...
						_0: A2(
							_rundis$elm_bootstrap$Bootstrap_Accordion$block,
							{
								...
								_0: _rundis$elm_bootstrap$Bootstrap_Card$blockAttrs(
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('chartBlock'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _rundis$elm_bootstrap$Bootstrap_Card$custom(
									A2(_user$project$TiltakView$chart, tiltakStates, tiltak)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Views$appFooter = A2(
	_elm_lang$html$Html$footer,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('footer footer-text'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('container__narrow'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$href('mailto:naf@toi.no'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Nils Fearnley'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('https://www.toi.no'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _user$project$Assets$src(_user$project$Assets$toiLogo),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('toiLogo'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$alt('TØI logo'),
													_1: {ctor: '[]'}
												}
											}
										},
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('colophon'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Utvikling og design: '),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$a,
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$href('http://www.72web.no'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('72web.no'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html$text(' ved Syver Enstad & Thomas Flemming'),
												_1: {ctor: '[]'}
											}
										}
									}),
...
var _user$project$Views$pageNotFound = A2(
	_rundis$elm_bootstrap$Bootstrap_Grid$container,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('container__narrow'),
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Ugyldig side'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html$text('Beklager, kan ikke finne siden'),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Views$groupIcon = function (group) {
	var _p0 = group;
	if (_p0.ctor === 'Belysning') {
		return _user$project$Assets$holdeplasser;
	} else {
		return _user$project$Assets$informasjon;
	}
};
var _user$project$Views$groupPanel = function (group) {
	return A2(
		_elm_lang$html$Html$a,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$href(
				_user$project$Group$groupPath(group)),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('groupPanel'),
				_1: {ctor: '[]'}
			}
		},
		{
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('groupIcon'),
										_1: {
											ctor: '::',
											_0: _user$project$Assets$src(
												_user$project$Views$groupIcon(group)),
											_1: {
												ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('group-box-title'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('group-box-title-text'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(
														_user$project$Group$groupTitle(group)),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _user$project$Assets$src(_user$project$Assets$caretRight),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('caretRight'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$alt(''),
														_1: {ctor: '[]'}
...
var _user$project$Views$pageHome = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('jumbotron homeHeader'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Gang- og sykkelveikalkulator'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Nyttekostnadsverktøy for sykkel- og gangveitiltak'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Publisert 2021'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('groupPanels container__narrow'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('forsidetekst'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
												...
												_1: {
													...
													_1: {
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html$text('Beregningsopplegget er dokumentert i '),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_elm_lang$html$Html$a,
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$href('https://www.toi.no/publikasjoner/article29858-8.html'),
																			_1: {ctor: '[]'}
																		},
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('TØI-rapport 1121'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('. Her fins også nærmere veiledning til utfylling og bruk av kalkulatoren, samt erfaringsbaserte anslag på tiltakenes kostnader'),
																		_1: {ctor: '[]'}
																	}
																}
															}),
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _user$project$Views$groupPanel(_user$project$Models$Belysning),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _user$project$Views$groupPanel(_user$project$Models$Vedlikehold),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$Views$pageGroup = F2(
	function (group, model) {
		var pageHeader = A2(
			_elm_lang$html$Html$header,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('groupHeader'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Assets$src(_user$project$Assets$backArrow),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('backArrow'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$alt('Tilbake til forsiden'),
										_1: {ctor: '[]'}
									}
								}
							},
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('groupPageHeader'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
		...
		var allCards = A2(
			_elm_lang$core$List$map,
			_user$project$TiltakView$tiltakCard(model.tiltakStates),
			_user$project$TiltakAndGroupData$tiltakForGroup(group));
		var tiltakAccordions = A2(
			...
			A2(
				...
				_rundis$elm_bootstrap$Bootstrap_Accordion$withAnimation(
					_rundis$elm_bootstrap$Bootstrap_Accordion$config(_user$project$Msgs$AccordionMsg))));
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
...
var _user$project$Views$mainContent = function (model) {
	var _p1 = model.page;
	switch (_p1.ctor) {
		case 'Home':
			return _user$project$Views$pageHome(model);
		case 'NotFound':
			return _user$project$Views$pageNotFound;
		default:
			return A2(_user$project$Views$pageGroup, _p1._0, model);
	}
};
var _user$project$Views$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Views$mainContent(model),
			_1: {
				ctor: '::',
				_0: _user$project$Views$appFooter,
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$Main$routeParser = function () {
	var groupToParser = function (group) {
		return A2(
			_evancz$url_parser$UrlParser$map,
			_user$project$Models$GroupPage(group),
			_evancz$url_parser$UrlParser$s(
				_user$project$Group$groupPathSansHash(group)));
	};
	return _evancz$url_parser$UrlParser$oneOf(
		A2(
			...
			A2(_elm_lang$core$List$map, groupToParser, _user$project$TiltakAndGroupData$alleTyper)));
}();
...
var _user$project$Main$computeGraphCmd = F3(
	function (tiltak, tiltakStates, _p0) {
		var _p1 = _p0;
		var graphId = A2(
			_user$project$Tiltak$sendTo,
			tiltak,
		...
		if (_p2._0.ctor === 'GraphOff') {
			if (_p2._1.ctor === 'GraphOn') {
				return _user$project$Ports$generateC3(graphData);
			} else {
				return _elm_lang$core$Platform_Cmd$none;
			}
		} else {
			if (_p2._1.ctor === 'GraphOn') {
				return _user$project$Ports$updateC3(graphData);
			} else {
				return _user$project$Ports$destroyC3(graphId);
			}
		}
	});
var _user$project$Main$updateGraphingState = F3(
	function (model, tiltak, newTiltakStates) {
		var newGraphState = A2(_user$project$TiltakCharting$graphState, tiltak, newTiltakStates);
		var oldGraphState = A2(_user$project$TiltakCharting$graphState, tiltak, model.tiltakStates);
		return {
			ctor: '_Tuple2',
			...
			_1: A3(
				_user$project$Main$computeGraphCmd,
				tiltak,
				newTiltakStates,
				{ctor: '_Tuple2', _0: oldGraphState, _1: newGraphState})
		};
	});
var _user$project$Main$updateField = F4(
	function (model, tiltak, field, stringValue) {
		var updatePreferredToGraph = function (preferredString) {
			var _p3 = A2(_user$project$TiltakCharting$maybeFieldToGraph, tiltak, model.tiltakStates);
			if (_p3.ctor === 'Just') {
				return _p3._0.name;
			} else {
		...
		var maybeValue = _elm_lang$core$Result$toMaybe(
			_elm_lang$core$String$toFloat(stringValue));
		var newTiltakStates = A3(
			...
			A3(
				...
				maybeValue,
				model.tiltakStates));
		return A3(_user$project$Main$updateGraphingState, model, tiltak, newTiltakStates);
	});
var _user$project$Main$updateFieldToGraph = F3(
	function (tiltak, field, model) {
		var focus = A2(
			_user$project$Tiltak$getAttr,
			tiltak,
			function (_) {
		...
		var newTiltakStates = A3(_evancz$focus$Focus$set, focus, field.name, model.tiltakStates);
		return A3(_user$project$Main$updateGraphingState, model, tiltak, newTiltakStates);
	});
var _user$project$Main$pageFromLocation = function (location) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Models$NotFound,
		_user$project$Main$decode(location));
};
var _user$project$Main$groupCreateCharts = F2(
	function (group, model) {
		return _elm_lang$core$Platform_Cmd$batch(
			A2(
				_elm_lang$core$List$map,
				_user$project$Ports$generateC3,
				A2(
					_elm_lang$core$List$map,
					function (tiltak) {
						return A2(_user$project$TiltakCharting$chartRecord, tiltak, model.tiltakStates);
					},
					A2(
						_elm_lang$core$List$filter,
						function (tiltak) {
							return _elm_lang$core$Native_Utils.eq(
								A2(_user$project$TiltakCharting$graphState, tiltak, model.tiltakStates),
								_user$project$TiltakCharting$GraphOn);
						},
						_user$project$TiltakAndGroupData$tiltakForGroup(group)))));
	});
var _user$project$Main$groupDestroyCharts = F2(
	function (group, model) {
		return _elm_lang$core$Platform_Cmd$batch(
			A2(
				_elm_lang$core$List$map,
				_user$project$Ports$destroyC3,
				A2(
					_elm_lang$core$List$map,
					function (tiltak) {
						return A2(
...
var _user$project$Main$destroyAndCreateCharts = F2(
	function (oldModel, newModel) {
		return _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: function () {
					var _p4 = oldModel.page;
					if (_p4.ctor === 'GroupPage') {
						return A2(_user$project$Main$groupDestroyCharts, _p4._0, oldModel);
					} else {
						return _elm_lang$core$Platform_Cmd$none;
					}
				}(),
				_1: {
					ctor: '::',
					_0: function () {
						var _p5 = newModel.page;
						if (_p5.ctor === 'GroupPage') {
							return A2(_user$project$Main$groupCreateCharts, _p5._0, newModel);
						} else {
							return _elm_lang$core$Platform_Cmd$none;
						}
					}(),
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_rundis$elm_bootstrap$Bootstrap_Accordion$subscriptions, model.accordionState, _user$project$Msgs$AccordionMsg),
			_1: {
				ctor: '::',
				_0: _user$project$Ports$charts(_user$project$Msgs$ChartsChanged),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$titleFromPage = function (page) {
	var appName = 'Gang- og sykkel-vei kalkulator';
	var _p6 = page;
	switch (_p6.ctor) {
		case 'Home':
			return appName;
		...
		default:
			return A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Group$groupTitle(_p6._0),
				A2(_elm_lang$core$Basics_ops['++'], ' - ', appName));
	}
};
var _user$project$Main$init = function (location) {
	var model = {
		page: _user$project$Main$pageFromLocation(location),
		accordionState: _rundis$elm_bootstrap$Bootstrap_Accordion$initialState,
		tiltakStates: _user$project$TiltakAndGroupData$initialTiltakStates,
		chartIds: {ctor: '[]'}
	};
	return {
		ctor: '_Tuple2',
		_0: model,
		_1: _user$project$Ports$setTitle(
			_user$project$Main$titleFromPage(model.page))
	};
};
		...
		switch (_p7.ctor) {
			case 'UrlChange':
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						page: _user$project$Main$pageFromLocation(_p7._0)
					});
				return {
					ctor: '_Tuple2',
					_0: newModel,
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: A2(_user$project$Main$destroyAndCreateCharts, model, newModel),
							_1: {
								ctor: '::',
								_0: _user$project$Ports$setTitle(
									_user$project$Main$titleFromPage(newModel.page)),
								_1: {ctor: '[]'}
							}
						})
				};
			case 'AccordionMsg':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{accordionState: _p7._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateField':
				return A4(_user$project$Main$updateField, model, _p7._0, _p7._1, _p7._2);
			case 'FieldBlur':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							tiltakStates: _p7._0.beDisplayMode(model.tiltakStates)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'FieldFocus':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							tiltakStates: _p7._0.beEditMode(model.tiltakStates)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ChartsChanged':
			...
			default:
				return A3(_user$project$Main$updateFieldToGraph, _p7._0, _p7._1, model);
		}
	});
var _user$project$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_user$project$Msgs$UrlChange,
	{view: _user$project$Views$view, update: _user$project$Main$update, subscriptions: _user$project$Main$subscriptions, init: _user$project$Main$init})();
